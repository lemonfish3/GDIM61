...
public class CutsceneManager : MonoBehaviour
{
    ...
    {
    "*Vulcana and Joanne walk onto the ancient ruins map*",
    ...
    "*They walk a little bit and then find a centaur lady exhausted on the ground. Vulcana gets ready to attack, but Joanne stops her.*",
    ...
    "*Joanne walks up to the centaur lady, while Vulcana remains stationary*",
    "Joanne: “Excuse me, are you alright?”",
    "*The centaur lady notices Joanne, slowly looking up at her*",
    ...
    "*The centaur lady takes a bit to calm down*",
    ...
    "*Vulcana puts down her guard and runs over to the centaur*",
    ...
    "*Vulcana and Joanne turn to each other*",
    ...
    "*They walk off to go to the temple*"
    };
